...
const routes: Array<RouteRecordRaw> = [
  ...
  {
    path: '/depreciacion/:activoId',
    name: 'depreciacion',
    // route level code-splitting
    // this generates a separate chunk (about.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: () => import(/* webpackChunkName: "about" */ '../views/DepreciacionView.vue')
  },
  {
    path: '/enviar-contabilidad',
    name: 'EnviarContabilidad',
    // route level code-splitting
    // this generates a separate chunk (about.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: () => import(/* webpackChunkName: "about" */ '../views/EnviarContabilidad.vue')
  },
]
